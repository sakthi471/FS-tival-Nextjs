    ...
    return (
        <Link href={`/characters/${character.id}`}>
            <div className='w-[250px] h-[390px] bg-red-600 shadow-xl flex flex-col gap-[5px] items-center '>
                ...
                <div className=' flex flex-col gap-5 h-[150px] w-full  px-4 bg-gray-300 py-6 hover:bg-red-600 duration-150 '>

                    <p className='  font-bold uppercase text-blacks'> {character.name} </p>
